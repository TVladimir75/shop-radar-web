...
_RAW: tuple[tuple[str, str], ...] = (
    ...
    ("furniture hardware", "петли, крепёж, кронштейны (не диваны)"),
    ("sofa", "диван, мягкая мебель"),
    ("wooden furniture", "деревянная мебель, столы"),
    ("dining table", "обеденный стол"),
    ("upholstery fabric", "ткань обивочная, мебельная"),
